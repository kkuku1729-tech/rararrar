...
local function LoadMainScript()
    ...
    -- Остальные функции (ESP, Speed, Noclip) остаются без изменений
    ...
    -- Остальной код GUI...
    -- [Закрытие, перемещение GUI и т.д.]
    ...
    print("ExpensiveMods successfully loaded! Aimbot with FOV and Fly fixed.")
end
